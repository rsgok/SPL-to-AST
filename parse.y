...
%type <node> program program_head routine routine_head routine_body sub_routine label_part const_part type_part var_part routine_part
...
routine_head:label_part const_part type_part var_part routine_part {
    $$=new TreeNode(routine_head,4,$2,$3,$4,$5);
};
label_part: { $$=new TreeNode(undefined, "label"); };
